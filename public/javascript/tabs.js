(function () {
  ...
  if (tabbed != null) {
    ...
    var panels = tabbed.querySelectorAll('[class^="tabcontent"]'); // The tab switching function
    ...
    var switchTab = function switchTab(oldTab, newTab) {
      ...
      newTab.parentNode.classList.add("selected");
      oldTab.removeAttribute('aria-selected');
      oldTab.parentNode.classList.remove("selected");
    ...
    Array.prototype.forEach.call(tabs, function (tab, i) {
      ...
      tab.setAttribute('aria-controls', id.substring(1)); //tab.parentNode.removeClass('noJsHide');
