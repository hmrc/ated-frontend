...
import forms.PropertyDetailsForms.dateFirstOccupiedForm

class DateFirstOccupiedSpec extends AnyFeatureSpec with GuiceOneAppPerSuite with MockitoSugar
  ...
  val title: String = "When was the property first occupied?"
  val injectedViewInstance: dateFirstOccupied = app.injector.instanceOf[views.html.propertyDetails.dateFirstOccupied]

  Feature("The user views the When was the property first occupied? page") {

    info("as a client I want to view the When was the property first occupied? page")
