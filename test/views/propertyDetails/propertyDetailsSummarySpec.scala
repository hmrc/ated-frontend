...
class propertyDetailsSummarySpec extends AnyFeatureSpecLike with GuiceOneAppPerSuite with MockitoSugar
  ...
  Feature("The user can view their property details summary before they submit it") {
    ...
    Scenario("return the basic summary with dates of liability") {
      ...
      assert(document.select("dl.govuk-summary-list:nth-child(9) > div:nth-child(1) > dt:nth-child(1)").text() === "Liable for charge")
      assert(document.select("dl.govuk-summary-list:nth-child(9) > div:nth-child(1) > dd:nth-child(2)").text === "1 April " + thisYear + " to 31 August "  + thisYear)
      assert(document.select("dl.govuk-summary-list:nth-child(10) > div:nth-child(1) > dt:nth-child(1)").text() === "Rental business")
      assert(document.select("dl.govuk-summary-list:nth-child(10) > div:nth-child(1) > dd:nth-child(2)").text === "1 September " + thisYear + " to 31 March " + nextYear)
      ...
      assert(document.select("#avoidance-scheme > div:nth-child(2) > dt").text() === "Avoidance scheme reference number")
      assert(document.select("#avoidance-scheme > div:nth-child(2) > dd.govuk-summary-list__actions > a").attr("href") === "/ated/liability/create/tax-avoidance-reference/edit-summary/1")
