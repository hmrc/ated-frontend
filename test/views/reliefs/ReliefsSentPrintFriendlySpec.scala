...
implicit lazy val authContext: StandardAuthRetrievals = organisationStandardRetrievals
  ...
  feature("The user can view the relief sent page") {
    ...
    scenario("show the relief sent page") {
      ...
      val html = views.html.reliefs.reliefsSentPrintFriendly(
        periodKey,
        Some(SubmitReturnsResponse(
      ...
      assert(document.select("#receipt-message").text === "The ATED charge for these returns is £0")
      ...
      assert(document.select("body > div.box > p:nth-child(13)").text === "If any change in your " +
      ...
      assert(document.select("body > div.box > p:nth-child(14)").text === "This will help to keep " +
      ...
      assert(document.select("body > div.box > p:nth-child(15)").text === "When emailing please " +
