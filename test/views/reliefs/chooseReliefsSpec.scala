...
class chooseReliefsSpec extends FeatureSpec with OneServerPerSuite with MockitoSugar with BeforeAndAfterEach with GivenWhenThen{
  ...
  feature("The user can view the choose reliefs page") {
    ...
    scenario("show the reliefs we can choose") {
      ...
      assert(document.getElementById("rentalBusinessDate_legend").text() === "What was the relief start date?")
      ...
      assert(document.getElementById("openToPublicDate_legend").text() === "What was the relief start date?")
      ...
      assert(document.getElementById("propertyDeveloperDate_legend").text() === "What was the relief start date?")
      ...
      assert(document.getElementById("propertyTradingDate_legend").text() === "What was the relief start date?")
      ...
      assert(document.getElementById("lendingDate_legend").text() === "What was the relief start date?")
      ...
      assert(document.getElementById("employeeOccupationDate_legend").text() === "What was the relief start date?")
      ...
      assert(document.getElementById("farmHousesDate_legend").text() === "What was the relief start date?")
      ...
      assert(document.getElementById("socialHousingDate_legend").text() === "What was the relief start date?")
      ...
      assert(document.getElementById("equityReleaseDate_legend").text() === "What was the relief start date?")
