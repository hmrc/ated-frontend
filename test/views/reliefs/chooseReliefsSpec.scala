...
class chooseReliefsSpec extends FeatureSpec with OneServerPerSuite with MockitoSugar with BeforeAndAfterEach with GivenWhenThen{
  ...
  feature("The user can view the choose reliefs page") {
    ...
    scenario("show the reliefs we can choose") {
      ...
      assert(document.getElementById("rentalBusinessDate_legend").text() === "When did the Rental business start? For example, 1 4 2015")
      ...
      assert(document.getElementById("openToPublicDate_legend").text() === "When did the Open to the public start? For example, 1 4 2015")
      assert(document.getElementById("openToPublicDate_hint").text() ===s"For example, ${PeriodUtils.periodStartDate(periodKey).toString(Messages("ated.date-format.numeric"))}")
      assert(document.getElementById("propertyDeveloper_field").text() === "Property developers")
      assert(document.getElementById("propertyDeveloperDate_legend").text() === "When did the Property developer start? For example, 1 4 2015")
      assert(document.getElementById("propertyDeveloperDate_hint").text() ===s"For example, ${PeriodUtils.periodStartDate(periodKey).toString(Messages("ated.date-format.numeric"))}")
      assert(document.getElementById("propertyTrading_field").text() === "Property trading")
      assert(document.getElementById("propertyTradingDate_legend").text() === "When did the Property trading start? For example, 1 4 2015")
      assert(document.getElementById("propertyTradingDate_hint").text() ===s"For example, ${PeriodUtils.periodStartDate(periodKey).toString(Messages("ated.date-format.numeric"))}")
      assert(document.getElementById("lending_field").text() === "Lending")
      assert(document.getElementById("lendingDate_legend").text() === "When did the Lending start? For example, 1 4 2015")
      assert(document.getElementById("lendingDate_hint").text() ===s"For example, ${PeriodUtils.periodStartDate(periodKey).toString(Messages("ated.date-format.numeric"))}")
      assert(document.getElementById("employeeOccupation_field").text() === "Employee occupation")
      assert(document.getElementById("employeeOccupationDate_legend").text() === "When did the Employee occupation start? For example, 1 4 2015")
      assert(document.getElementById("employeeOccupationDate_hint").text() ===s"For example, ${PeriodUtils.periodStartDate(periodKey).toString(Messages("ated.date-format.numeric"))}")
      assert(document.getElementById("farmHouses_field").text() === "Farmhouses")
      assert(document.getElementById("farmHousesDate_legend").text() === "When did the Farmhouse start? For example, 1 4 2015")
      assert(document.getElementById("farmHousesDate_hint").text() ===s"For example, ${PeriodUtils.periodStartDate(periodKey).toString(Messages("ated.date-format.numeric"))}")
      assert(document.getElementById("socialHousing_field").text() === "Social housing")
      assert(document.getElementById("socialHousingDate_legend").text() === "When did the Social housing start? For example, 1 4 2015")
      assert(document.getElementById("socialHousingDate_hint").text() ===s"For example, ${PeriodUtils.periodStartDate(periodKey).toString(Messages("ated.date-format.numeric"))}")
      assert(document.getElementById("equityRelease_field").text() === "Equity release scheme (home reversion plans)")
      assert(document.getElementById("equityReleaseDate_legend").text() === "When did the Equity release scheme (home reversion plans) start? For example, 1 4 2015")
      assert(document.getElementById("equityReleaseDate_hint").text() ===s"For example, ${PeriodUtils.periodStartDate(periodKey).toString(Messages("ated.date-format.numeric"))}")
    ...
    scenario("show the reliefs we have previously chosen") {
      ...
      val reliefs = Reliefs(periodKey = periodKey, rentalBusiness = true, openToPublic = false)
