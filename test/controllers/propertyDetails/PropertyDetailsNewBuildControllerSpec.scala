        ...
        "show the chargeable property details view if we id and data" in {
          ...
          getDataWithAuthorisedUser("1", propertyDetails) {
            result =>
              ...
              document.getElementById("notNewBuildValue_field").text() must be("What was the value of the property on the date it was acquired, in GBP? For example, 1,500,000")
              ...
              document.getElementById("newBuildValue_field").text() must be("What was the value of the property in GBP at this date? For example, 1,500,000")
